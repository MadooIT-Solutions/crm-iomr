...
class CrmLeadRotation(models.Model):
    ...
    lead_id = fields.Many2one('crm.lead', string='Oportunidade', required=True, ondelete='cascade')
    ...
    ], string='Tipo de Rotação', default='manual')
    days_with_seller = fields.Integer(string='Dias com Vendedor')
    date_rotation = fields.Datetime(string='Data da Rotação', default=fields.Datetime.now)
