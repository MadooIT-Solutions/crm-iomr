...
def _estimate_lead_commission(env, lead, commission, performance_pct):
    ...
    IS-CRM bonus or penalty, and evaluate the policy at 100% when no target is
...
def get_dashboard_values(env, date_from, date_to):
    ...
    # SDRs only see their own opportunities. Orientadoras and sales users
    # linked to an Orientadora profile may see the linked SDR opportunities.
